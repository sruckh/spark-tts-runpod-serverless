...
class S3Manager:
    ...
    def get_bucket_usage(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Calculate totals
            stats['total']['count'] = stats['voices']['count'] + stats['output']['count']
            stats['total']['size_bytes'] = stats['voices']['size_bytes'] + stats['output']['size_bytes']
            ...
            logger.info(f"Bucket usage: {stats['total']['count']} files, {stats['total']['size_human']}")
            return stats
